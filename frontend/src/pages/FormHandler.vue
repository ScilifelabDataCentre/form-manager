<template>
  <q-page padding class="col justify-center q-mt-xl">
        ...
        <q-card>
          ...
          <q-tab-panels v-model="tab" animated>
            <q-tab-panel name="config">
              <form-config :identifier="selected" @form-deleted="leaveForm" />
            </q-tab-panel>
    ...
    <q-dialog v-model="showLeaveFormDialog">
      <q-card>
        <q-card-section class="row items-center">
          ...
          <span class="q-ml-sm"
            >Are you sure you want to abandon any changes to the form?</span
          >
        </q-card-section>
